...
Assume that value of pi is . You don't need more digits for this problem; use the value exactly as it is, just ignore the floating point and don't perform any rounding operations.

Input Format

The first line will contain an integer , representing the number of test cases. Each of the next  lines will contain a song. The songs will contain only English letters (a-z, A-Z) and will contain 1 to 29 words.

Constraints:

No line will contain a total of more than_  _characters.
